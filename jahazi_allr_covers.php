...
<title>Fire, burglary & risks </title>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        <div id="templatemo_content" class="left">
            <div class="post">
                <img src='show_image.php' width='200px' height='200px';>
...
$query="SELECT * FROM `post` WHERE `title` = 3 ORDER BY `title` DESC LIMIT 0, 1 " or die("Query one failed".mysql_error());
