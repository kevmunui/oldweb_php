...
if(isset($_SESSION['user'])){
		...
		if(isset($_POST['user_number']) && isset($_POST['pass']) && isset($_POST['email']))
		{
		...
		if((!empty($user))  && !empty($pass) && !empty($email)){
			...
			$query = "SELECT user_id FROM premium WHERE user_id = '$user'";
							...
							$query = "INSERT INTO `premium` VALUES ( '','".mysql_real_escape_string($user)."','".mysql_real_escape_string($pass)."','".mysql_real_escape_string($email)."')";
    ...
    <div id="templatemo_main">
        ...
        <div class="clear"></div>
           ...
           <h3>edit client's account</h3>
            ...
            <form action='new_client_premium.php' method="POST">
                <span class="errormsg"><?php echo $msg ;?></span><br><br>



				<label>User's Number (* required )</label>
				<input type='number' placeholder='user number' name='user_number' class="input_field">
				<label>User's new premium (* required )</label>
				<input type='number' placeholder='premium' name='pass' class="input_field">
				
				<label>Date Due (* required )</label>
				<input type='date' placeholder='date due' name='email' class="input_field">
