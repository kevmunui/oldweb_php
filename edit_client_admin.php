...
<H3 id='font'>EDIT CLIENTS ACCOUNT</H3><br><br><br><br>
...
include_once "global_setting.php";
	...
	while ( $info=mysql_fetch_array($result)){
		...
		echo'</table>';
		ECHO'<BR>';
		echo"<a href=\"edit_data.php?id=".$info['id']."\" class='errormsg'>Edit users information</a>";
		echo" ";
		echo" ";
		echo"<a href=\"delete_data.php?id=".$info['id']."\" >Delete users information</a>";
		ECHO'<BR>';	
		ECHO'<BR>';
		echo "<br>";
		}
