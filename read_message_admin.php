...
include_once "global_setting.php";
	...
	$q=mysql_query("UPDATE `message` SET `hits`='1' WHERE `id` = 'GET[id]' ",$connection) or die("Query failed".mysql_error());
...
<div id="templatemo_wrapper">
	...
	include_once "global_setting.php";
			...
			$result = mysql_query("SELECT * FROM `message` ORDER BY id DESC LIMIT 0, 5",$connection) or die("Query failed".mysql_error());
			...
			while($info = mysql_fetch_array($result))
			{
				...
				$sname = $info['sname'];
				$user = $info['user'];
				$bodysynp = substr($info['message'],0,1000);
				...
				echo $info['user'];
				echo "<br>";
				echo "<a href = 'read_message_admin_all.php?id=".$id."'>".$info['subject']."</a><br />";
				echo "<br>";
				printf("%s[...]<br/>",$bodysynp);
				echo "</fieldset>";
