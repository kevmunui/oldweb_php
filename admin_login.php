<?php
	...
	$query = "SELECT name,password FROM `admin` WHERE name = '$name' AND password = '$pswd'" ;
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div class="clear"></div>
            ...
            <div id="comment_form">
            <h3>Administrator's Log In</h3>
            
            <form action="admin_login.php" method="post">
                <label>UserName (* required )</label>
                <input type="text" name="user" class="input_field" />
        ...
        <div id="templatemo_sidebar" class="right">
       		<div class="sidebar_section">
                ...
                <ul class="nobullet sidebar_link rc_comment">
                    <li><a href="client_login.php"><span>Client's login</span></a></li>
