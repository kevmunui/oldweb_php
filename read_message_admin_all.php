...
include_once "global_setting.php";
	...
	$q=mysql_query("UPDATE `message` SET `hits`='1' WHERE `id` = '".$_GET['id']."' ",$connection) or die("Query failed".mysql_error());
...
<?php 
	...
	$result = mysql_query("SELECT * FROM `message` WHERE `id` ="."'".$ID."'",$connection) or die("Query failed".mysql_error());
