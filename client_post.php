...
if(isset($_SESSION['user1'])){
	...
	$query ="SELECT * FROM clients WHERE user = '".$userd."' ";
	...
	$results = mysql_query("SELECT * FROM clients WHERE user= $userd ") or die("Query failed".mysql_error());
	...
	echo '<title>'.$name1.' '.$name2.'</title>';
	}
	elseif($num==0)
	{
		echo "there seems to be no records!";
	}
	mysql_close();
        ...
        <div id="templatemo_sidebar" class="right">
       		<div class="sidebar_section">
				...
				<ul class="nobullet sidebar_link rc_comment">
                    ...
                    <li><a href="message_client_data.php?id=<?php echo $id; ?>" class='errormsg'><span>Send Us A Message</span></a></li>
                    <li><a href="premium.php?id=<?php echo $id; ?>" class='errormsg'><span>See your premium</span></a></li>
