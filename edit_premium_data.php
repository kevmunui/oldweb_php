...
if(isset($_POST['submit'])){
	...
	$query="UPDATE `premium` SET `premium` = '$_POST[premiums]',`date`= '$_POST[date]' WHERE `id` = $_POST[id] ";
	
	mysql_query($query)or die("Query failed".mysql_error());
	
	header('location:edit_client_premium.php');
...
ELSEif(!isset($_POST['submit'])){
	...
	$query = "SELECT * FROM premium WHERE id =$_GET[id]"or die("Query one failed".mysql_error());
        ...
        <div class="clear"></div>
           ...
           <h3>edit client's premiums</h3>
            ...
            <form action="update_client.php" method="POST">
				...
				<input type='text'  name='premiums' value='<?php echo $person['premium'];?>' class="input_field">
				<label>Due Date (* required )</label>
				<input type='text'  name='date' value='<?php echo @$person['date'];?>'class="input_field">
